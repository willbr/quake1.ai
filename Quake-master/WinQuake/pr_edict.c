...
#if !NATIVE_GAME  /* VM-era progs inspection/debug functions */
...
#endif  /* !NATIVE_GAME — end of VM-era progs inspection functions */
...
#endif /* NATIVE_GAME / !NATIVE_GAME for ED_ParseEdict */
