...
- `ref/Quake-Tools-master/`, `ref/quake_map_source-master/` — upstream references, do not modify. (Removed 2026-06-07: the Quake 2 trees `ref/Quake-2-master/` + `ref/Quake-2-Tools-master/`, the `ref/quake106/` shareware installer, `ref/fteqw-master/`, and `ref/TrenchBroom-master/`. Salvaged ideas live in `docs/{quake2,quaked,fteqw,trenchbroom}-ideas-to-steal.md`.)
