...
- `ref/Quake-Tools-master/`, `ref/TrenchBroom-master/`, `ref/fteqw-master/`, `ref/quake_map_source-master/` — upstream references, do not modify. (The Quake 2 trees `ref/Quake-2-master/` + `ref/Quake-2-Tools-master/` and the `ref/quake106/` shareware installer were removed 2026-06-07; Q2's salvageable ideas live in `docs/quake2-ideas-to-steal.md`.)
