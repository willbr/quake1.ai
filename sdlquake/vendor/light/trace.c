...
{
	/* tnodes was malloc'd via qbsp's tracked allocator; it'll be freed on
	 * the next qbsp run by qbsp_free_all_tracked. Clearing the pointers
	 * here just stops a second bake from reading the dead buffer. */
	tnodes = 0;
	tnode_p = 0;
}
